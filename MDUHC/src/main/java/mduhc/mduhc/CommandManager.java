...
import mduhc.mduhc.SubComms.GenerateWorlds;
import mduhc.mduhc.SubComms.Start;
import mduhc.mduhc.SubComms.SubCommandMaster;
...
public class CommandManager implements CommandExecutor
{
    ...
    public CommandManager(MDUHC parent)
    {
        pr=parent;
        //cia dedamos komandu klases
        subcomms.add(new Start());
        subcomms.add(new GenerateWorlds());
